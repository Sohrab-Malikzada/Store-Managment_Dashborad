...
export function PayrollActionsHeader({ 
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
      ...
      <div className="flex flex-12  mt-1   ml-35 gap-1">
        <Button 
          variant="outline" 
          onClick={onAdvancePayment}
          className="-mt-6 w-35 text-[12px] shadow-[0_4px_6px_-1px_hsl(0,0%,80%,0.5)] cursor-pointer hover:text-[hsl(216,32%,17%))]  hover:bg-[hsl(142,76%,45%)]/10  mr-2  rounded-[10px] text-[hsl(142,76%,36%)] bg-[hsl(248,250%,98%)] border-[hsl(142deg,76%,36%,20%)] hover:shadow-medium transition-smooth"
        >
