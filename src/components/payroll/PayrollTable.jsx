              ...
              <TableCell>
                <div className="flex gap-1">
                  <Button 
                    ...
                    className="hover:bg-primary/20 hover:text-primary transition-smooth rounded-full"
                  >
                  ...
                  <Button 
                    ...
                    className="hover:bg-warning/20 hover:text-warning transition-smooth rounded-full"
                  >
