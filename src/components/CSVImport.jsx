...
export function CSVImport({ onImport }) {
  ...
  return (
    <Button
      variant="outline"
      className="flex items-center gap-4 shadow-[0_4px_6px_-1px_hsl(0,0%,80%,0.5)] hover:shadow-medium hover:bg-[hsl(214,20%,95%)] transition-smooth border-[hsl(214,20%,88%)] rounded-[10px] cursor-pointer"
      onClick={() => {
