  ...
  return (
    <div className="space-y-8 m-6">
      ...
      <Tabs defaultValue="sales" className="space-y-4x">
            ...
            <CardHeader className="flex flex-row items-center justify-between">
              <Dialog open={showSaleReturnDialog} onOpenChange={setShowSaleReturnDialog}>
                <DialogTrigger asChild >
                  <Button className="ml-auto  gradient-primary w-41 text-white">
        ...
        <TabsContent value="purchases" className="space-y-4 w-full">
          <Card className=" bg-[hsl(0,0%,100%)] mt-[10px] border-[hsl(214,20%,88%)]">
              <div className="flex flex-col  ml-6 items-left">
            ...
            <CardHeader className="flex flex-row items-center justify-between">
              <Dialog open={showPurchaseReturnDialog} onOpenChange={setShowPurchaseReturnDialog}>
                <DialogTrigger asChild>
                  <Button className="ml-auto  gradient-primary w-50 text-white">
